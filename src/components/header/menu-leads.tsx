...
import { Calendar, Camera, GalleryHorizontalEnd, Grid3X3, LayoutDashboard, MessageSquareText, Newspaper, Server, Settings, Undo2, Video } from "lucide-react"
import { useSession } from "next-auth/react"
import Link from "next/link"
import { useParams, usePathname } from "next/navigation"


export default function MenuLeads() {
    ...
    const data= [
        ...
        {
            href: `/${agencySlug}/${clientSlug}/leads`,
            icon: Settings,
            text: "Configuración",
            roles: alowedRoles
        },
        {
            href: `/${agencySlug}/${clientSlug}/leads/agentes`,
