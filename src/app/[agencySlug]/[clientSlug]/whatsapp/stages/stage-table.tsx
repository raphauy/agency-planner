...
export function DataTableToolbar<TData>({ table }: DataTableToolbarProps<TData>) {
  ...
  return (
    <div className="flex gap-1 dark:text-white items-center">
          ...
          <Input className="max-w-xs" placeholder="order filter..."
          ...
          <Input className="max-w-xs" placeholder="isFinal filter..."
              value={(table.getColumn("isFinal")?.getFilterValue() as string) ?? ""}
              onChange={(event) => table.getColumn("isFinal")?.setFilterValue(event.target.value)}                
          />
          
      
          <Input className="max-w-xs" placeholder="color filter..."
              value={(table.getColumn("color")?.getFilterValue() as string) ?? ""}
              onChange={(event) => table.getColumn("color")?.setFilterValue(event.target.value)}                
          />
