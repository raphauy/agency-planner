...
export function DataTableToolbar<TData>({ table, agencies, clients, billableTypes }: DataTableToolbarProps<TData>) {
  ...
  return (
    <div className="flex gap-1 dark:text-white items-center">
      ...
      {agencies && table.getColumn("agency") && (
...
export function DataTable<TData, TValue>({
  ...
  return (
    <div className="w-full space-y-4 dark:text-white">
      <DataTableToolbar table={table} agencies={agencies} clients={clients} billableTypes={billableTypes}/>
